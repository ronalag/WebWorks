...
public class GPATools {
     ...
     *            New Height
     * @param nFilterType
     *            Filter quality to use. Can be <code>Bitmap.FILTER_LANCZOS</code>, <code>Bitmap.FILTER_BILINEAR</code> or
     *            <code>Bitmap.FILTER_BOX</code>.
     * @param nAspectRatio
     *            Specifies how the picture is resized. Can be <code>Bitmap.SCALE_TO_FIT</code>, <code>Bitmap.SCALE_TO_FILL</code>
     *            or <code>Bitmap.SCALE_STRETCH</code>.
