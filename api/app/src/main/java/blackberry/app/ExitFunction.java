...
/**
 * Implements blackberry.app.exit function.
 */
public final class ExitFunction extends ScriptableFunctionBase {
    ...
    public Object execute( Object thiz, Object[] args ) {
        Application.getApplication().invokeLater( new ExitRunner() );
        return UNDEFINED;
    }
