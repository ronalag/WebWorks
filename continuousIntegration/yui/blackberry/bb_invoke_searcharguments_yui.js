(function() {
    ...
    function generateTestCaseCallback(Y) {
        ...
        testCases[0] = new Y.Test.Case({
			...
			"MANUAL 1 should invoke Search with empty SearchArguments": function() {
			...
			"MANUAL 2 should invoke Search with SearchArguments with only text set": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL 3 should invoke Search with SearchArguments with only name set": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL 4 should invoke Search with SearchArguments with text/name set": function() {
				framework.test = this; //so pass() and fail() can access this test
