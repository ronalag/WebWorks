	...
	function generateTestCaseCallback(Y){
		...
		testCases[1] = new Y.Test.Case({
            ...
            "blackberry.phone.PhoneLogs.FOLDER_MISSED_CALLS should exist and return 0" : function() {
					...
					"blackberry.phone.PhoneLogs.numberOfCalls() should return a number" : function() {
						Assert.isNotUndefined(blackberry.phone.PhoneLogs.numberOfCalls);
						Assert.isNumber(blackberry.phone.PhoneLogs.numberOfCalls(blackberry.phone.PhoneLogs.FOLDER_MISSED_CALLS));
					},
		...
		testCases[2] = new Y.Test.Case({
					...
					"blackberry.phone.PhoneLogs.find() should exist and return an array" : function() {
