...
//blackberry.ui.dialog manual test			
             "MANUAL standardAsk D_OK_noOptions should pop up message OK button only": function() {
                framework.test = this;
			 ...
			 "MANUAL standardAsk Save dialog (Save, Disgard, Cancel) should work": function() {
                framework.test = this;
				framework.setInstructions("standardAsk OK dialog with globalStatus=true.<br />Pass this test if this is true.  Otherwise, fail.");
			...
			"MANUAL standardAsk Save dialog with default choice C_DISCARD should work": function() {
                framework.test = this;
			...
			"MANUAL standardAsk DELETE dialog (Delete, Cancel) should work": function() {
                framework.test = this;
			...
			"MANUAL standardAsk DELETE dialog with default choice C_DELETE should work": function() {
                framework.test = this;
			...
			"MANUAL standardAsk YES_NO dialog (YES, NO) should work": function() {
                framework.test = this;
			...
			"MANUAL standardAsk YES_NO dialog with default choise NO should work": function() {
                framework.test = this;
				framework.setInstructions("standardAsk YES_NO dialog   (YES, NO).<br />Pass this test if this is true.  Otherwise, fail.");
			...
			"MANUAL standardAsk OK_CANCEL dialog (OK, CANCEL) should work": function() {
                framework.test = this;
			...
			"MANUAL standardAsk OK_CANCEL dialog with choise CANCEL should work": function() {
                framework.test = this;
			...
			"MANUAL customAsk_withoutOptions() should work": function() {
                framework.test = this;
			...
			"MANUAL customAsk_SecondOption() should work": function() {
                framework.test = this;
				var carArr = new Array("Focus", "Volvo", "BMW");
			...
			"MANUAL customAsk_SecondOption_true() should work": function() {
                framework.test = this;
				var carArr = new Array("Focus", "Volvo", "BMW");
			...
			"MANUAL undefinded - Timeout afer pops up dialog should work": function() {
			...
			"MANUAL undefinded - pops up dialog with setting to background apps should work": function() {
				framework.test = this; //so pass() and fail() can access this test
				framework.setInstructions("customAsk_SecondOption_true().<br />Pass this test if this is true.  Otherwise, fail.");
				var t = blackberry.ui.dialog.standardAsk(blackberry.ui.dialog.D_YES_NO, "Do you like basketball?");
			...
			"MANUAL undefinded - background apps only should work": function() {
