(function() {
    ...
    function generateTestCaseCallback(Y) {
        ...
        testCases[0] = new Y.Test.Case({
			...
			//Invoke Java (Memo)
			"MANUAL 1 should invoke Search with SearchArguments with only appName": function() {
			...
			"MANUAL 2 should invoke Java Application with JavaArguments and entrypoint": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL 3 should invoke Java Application with JavaArguments and entrypoint with parameters": function() {
				framework.test = this; //so pass() and fail() can access this test
				framework.setInstructions("No test steps yet");
