...
//exsitence test			
			...
			"blackberry.system.setHomeScreenBackground doesnt support local protocol" : function() {
...
//system manual test 	
			...
			"MANUAL 1 blackberry.system.setHomeScreenBackground should work when images from SDCard/store" : function() {
			    ...
			    blackberry.system.setHomeScreenBackground("file:///SDCard/dir/pic1.jpg");
                alert("Home Screen Background has been set!");
				framework.test.wait(24*60*60*1000); 
			},
			
			"MANUAL 2 blackberry.system.model should return device mode" : function() {
				framework.test = this; 
				alert(blackberry.system.model);
				framework.test.wait(24*60*60*1000); 
			},	
				
			"MANUAL 3 blackberry.system.hasCapability all return values should be boolean" : function() {
				framework.test = this; //so pass() and fail() can access this test
...
//system.event exsitence	
			...
			"blackberry.system.onCoverageChange should be a function" : function() {
				Assert.isTypeOf('function', blackberry.system.event.onCoverageChange(function(){var s = 0;}));
			},
			
			"blackberry.system.onHardwareKey should be a function" : function() {
				Assert.isTypeOf('function', blackberry.system.event.onHardwareKey(7, function(){var s = 7;}));
			},
			
		           
			"MANUAL 4 blackberry.system.handle_KEY_BACK should work" : function() {
				framework.test = this;
			...
			"MANUAL 5 blackberry.system.KEY_BACK unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 6 blackberry.system.handle_KEY_MENU should work" : function() {
				framework.test = this;
			...
			"MANUAL 7 blackberry.system.KEY_MENU unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 8 blackberry.system.handle_KEY_CONVENIENCE_1 should work" : function() {
				framework.test = this;
			...
			"MANUAL 9 blackberry.system.KEY_CONVENIENCE_1 unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 10 blackberry.system.handle_KEY_CONVENIENCE_2 should work" : function() {
				framework.test = this;
			...
			"MANUAL 11 blackberry.system.KEY_CONVENIENCE_2 unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 12 blackberry.system.handle_KEY_STARTCALL should work" : function() {
				framework.test = this;
			...
			"MANUAL 13 blackberry.system.KEY_STARTCALL unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 14 blackberry.system.handle_KEY_ENDCALL should work" : function() {
			...
			"MANUAL 15 blackberry.system.KEY_ENDCALL unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 16 blackberry.system.handle_KEY_VOLUMEDOWN should work" : function() {
				framework.test = this;
			...
			"MANUAL 17 blackberry.system.KEY_VOLUMEDOWN unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 18 blackberry.system.handle_KEY_VOLUMEUP should work" : function() {
				framework.test = this;
    		...
    		"MANUAL 19 blackberry.system.KEY_VOLUMEUP unregistry should work" : function() {
				framework.test = this;
			...
			"MANUAL 20 blackberry.system.onCoverageChange() should work" : function() {
			    framework.test = this;
