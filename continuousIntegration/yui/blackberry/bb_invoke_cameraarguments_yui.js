    ...
    function generateTestCaseCallback(Y) {
        ...
        testCases[0] = new Y.Test.Case({
			...
			"blackberry.invoke.CameraArguments.VIEW_CAMERA should exist" : function() {
				...
				Assert.areSame(0, blackberry.invoke.CameraArguments.VIEW_CAMERA);
			},
			...
			"blackberry.invoke.CameraArguments.VIEW_RECORDER should exist" : function() {
				...
				Assert.areSame(1, blackberry.invoke.CameraArguments.VIEW_RECORDER);
			},						
			...
			"MANUAL 1 should invoke Camera and go to camera mode": function() {
			...
			"MANUAL 2 should invoke Camera and go to recorder mode": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL 3 should invoke Camera with a string and go to default camera mode": function() {
				framework.test = this; //so pass() and fail() can access this test
