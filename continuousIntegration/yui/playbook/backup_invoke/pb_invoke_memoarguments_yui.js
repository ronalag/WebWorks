    ...
    function generateTestCaseCallback(Y) {
        ...
        testCases[0] = new Y.Test.Case({
			...
			"blackberry.invoke.MemoArguments.VIEW_NEW should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.MemoArguments.VIEW_NEW, 0);
			},
			...
			"blackberry.invoke.MemoArguments.VIEW_EDIT should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.MemoArguments.VIEW_EDIT, 1);
			},	    
			
			//Invoke Memo with no parameters and VIEW_NEW
			"Manual Test 1 should invoke memo with no parameters and VIEW_NEW": function() {
			...
			"Manual Test 2 should invoke memo with parameters and VIEW_NEW": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 3 should invoke memo with parameters and VIEW_EDIT": function() {
				framework.test = this; //so pass() and fail() can access this test
				framework.setInstructions("Memo compose shows up with parameters");
