    ...
    function generateTestCaseCallback(Y) {
        ...
        testCases[0] = new Y.Test.Case({
			...
			"blackberry.invoke.CalendarArguments.VIEW_NEW should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.CalendarArguments.VIEW_NEW, 0);
			},
			...
			"blackberry.invoke.CalendarArguments.VIEW_VIEW should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.CalendarArguments.VIEW_VIEW, 1);
			},
			...
			"blackberry.invoke.CalendarArguments.VIEW_AGENDA should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.CalendarArguments.VIEW_AGENDA, 2);
			},
			...
			"blackberry.invoke.CalendarArguments.VIEW_DAY should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.CalendarArguments.VIEW_DAY, 3);
			},
			...
			"blackberry.invoke.CalendarArguments.VIEW_DEFAULT should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.CalendarArguments.VIEW_DEFAULT, 4);
			},
			...
			"blackberry.invoke.CalendarArguments.VIEW_MONTH should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.CalendarArguments.VIEW_MONTH, 5);
			},
			...
			"blackberry.invoke.CalendarArguments.VIEW_WEEK should exist" : function() {
				...
				Assert.areSame(blackberry.invoke.CalendarArguments.VIEW_WEEK, 6);
			},
			
			//Invoke Calendar with empty CalendarArguments
			"Manual Test 1 should invoke Calendar with empty CalendarArguments": function() {
			...
			"Manual Test 2 should invoke Calendar with VIEW_NEW CalendarArguments": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 3 should invoke Calendar with VIEW_VIEW CalendarArguments": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 4 should invoke Calendar with VIEW_AGENDA CalendarArguments": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 5 should invoke Calendar with VIEW_DAY CalendarArguments": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 6 should invoke Calendar with VIEW_DEFAULT CalendarArguments": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 7 should invoke Calendar with VIEW_MONTH CalendarArguments": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 8 should invoke Calendar with VIEW_WEEK CalendarArguments": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 9 should invoke Calendar with CalendarArguments with view=7": function() {
				framework.test = this; //so pass() and fail() can access this test
				framework.setInstructions("Calendar application should show up with default.");
			...
			"Manual Test 10 should invoke Calendar with CalendarArguments with view=string": function() {
				framework.test = this; //so pass() and fail() can access this test
				framework.setInstructions("Calendar application should show up with default.");
			...
			"Manual Test 11 should invoke Calendar with CalendarArguments with Date object": function() {
				framework.test = this; //so pass() and fail() can access this test
			...
			"Manual Test 12 should invoke Calendar with CalendarArguments with Appointment Object": function() {
				framework.test = this; //so pass() and fail() can access this test
