(function() {               
	...
	function generateTestCaseCallback(Y){
		...
		testCases[0] = new Y.Test.Case({
			...
			"MANUAL css font family should work": function () {
			...
			"MANUAL css font style should work": function () {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL css font size should work": function () {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL css font weight should work": function () {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL css background image should work": function () {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL css background repeat should work": function () {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL css box model should work": function () {
				framework.test = this; //so pass() and fail() can access this test
			...
			"MANUAL css box absolute offset should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css border should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css border color should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css color should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css line height should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css text align should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css text decoration should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css text indent should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css text transform should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css counter increment should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css hover change layout should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css pseudo element after should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css first child should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css first letter should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css first line should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css table spacing should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css empty cells should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css table layout should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css list style type should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css list style image position and type should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css top bottom left right should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css float image should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css image gallery should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css overflow should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css fixed text should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css z index should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css margin should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
			...
			"MANUAL css padding should work": function () {
				framework.test = this; //so pass() and fail() can access this test
				document.getElementById('instructions').innerHTML = "according to the instruction on the test page";
